...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col selection:bg-blue-600 selection:text-white">
      {/* ── Top Navigation Bar ────────────────────────────────────────── */}
      <header className="sticky top-0 z-40 bg-slate-50/95 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              <Link
                href="/dashboard"
                className="px-4 py-2 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors inline-flex items-center gap-1.5"
              >
      ...
      <section className="relative pt-12 pb-16 md:pt-20 md:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="text-center max-w-3xl mx-auto space-y-6">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/login"
              className="w-full sm:w-auto px-6 py-3.5 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors inline-flex items-center justify-center gap-2"
            >
              <span>Create a Poll</span>
            ...
            <a
              href="#showcase"
              className="w-full sm:w-auto px-6 py-3.5 text-sm font-semibold text-slate-700 hover:text-slate-900 bg-white hover:bg-slate-100 border border-slate-300 rounded-lg transition-colors inline-flex items-center justify-center gap-2"
            >
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 max-w-xl mx-auto">
            <button
              ...
              className={`px-4 py-2.5 text-xs font-bold rounded-lg border transition-colors flex items-center gap-2 ${
                activeTab === 'create'
          ...
          <div className="max-w-4xl mx-auto bg-white border border-slate-300 rounded-xl overflow-hidden">
            ...
            {activeTab === 'create' && (
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-slate-200 rounded-lg p-4 bg-slate-50 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] font-semibold text-slate-500">Max Choices: 1 Candidate</span>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="p-3 bg-white border border-slate-300 rounded-md flex items-center gap-3">
                ...
                <div className="pt-2 flex justify-end">
                  <Link
                    href="/login"
                    className="px-4 py-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors inline-flex items-center gap-1.5"
                  >
                  ...
                  <div className="space-y-4 text-xs">
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-3 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded font-semibold whitespace-nowrap"
                        >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 bg-blue-50 text-blue-700 border border-blue-200 rounded font-semibold text-xs"
                        >
                          Native Mobile Share
                        </button>
                    ...
                    <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-md">
                      <p className="text-[11px] font-semibold text-emerald-800">
                        Live Turnout Counter: 1,420 / 1,850 Eligible Ballots Cast (76.7%)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      ...
                      <div className="w-full h-3 bg-slate-100 rounded-full overflow-hidden border border-slate-200">
                        <div className="h-full bg-blue-600 rounded-full" style={{ width: '60.8%' }} />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="w-full h-3 bg-slate-100 rounded-full overflow-hidden border border-slate-200">
                        <div className="h-full bg-slate-500 rounded-full" style={{ width: '39.2%' }} />
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
            ...
            <button
              type="button"
              onClick={handleCopyPageUrl}
              className="px-4 py-2 text-xs font-semibold text-slate-700 bg-white hover:bg-slate-50 border border-slate-300 rounded-lg transition-colors flex items-center gap-1.5"
            >
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="bg-slate-900 text-white rounded-2xl p-8 sm:p-12 text-center space-y-6">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              href="/login"
              className="w-full sm:w-auto px-6 py-3.5 text-sm font-semibold text-slate-200 hover:text-white bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg transition-colors inline-flex items-center justify-center gap-2"
            >
